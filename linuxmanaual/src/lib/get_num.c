 ...
 * command-line argument ('name'),and a dianostic error message ('msg').
 */
 ...
 * return as the function result,'flags' is a bit mask of flags controlling
 * how the conversion si done and what diagnostic checks are performed on the
 * numeric result,see get_num.h for details,
 * 'fname' is the name of our claaer,and 'name' is the name associated with
 ...
 *Convert comments for getNum() for a descritption of the arguments to this function
 */
