...
/*
 * Dispaly error message including 'error' diagnostic,and
 * return to caller
 */
...
/*
 * Display error message including 'error' diagnostic,and
 ...
 * function that creates a child process that must then etrminate
...
/*
 * Print an command usage error message and terminate the process */
