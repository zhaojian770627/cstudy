...
static void usageError(const char *progName)
{
  ...
  fprintf(stderr,"       \"n\" means in include IPC_NOWAIT in 'op'\n");
  fprintf(stderr,"       \"u\" means in include SEM_UNDO in 'op'\n");
...
/* Parse comma-delimited operations in 'arg',returning then in the
 array 'sops'.Return number*/
